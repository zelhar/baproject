...
def biasedPropagateGA(G, A=None, bias=None, alpha=0.2, epsilon=1e-7, maxiter=10 ** 7):
    ...
    alpha: the restart parameter, must be between 0 and 1.
        ...
        the graph walk probability. default is 0.2
...
x, df = predictMethod2(G, tries=5, alpha=0.2)
